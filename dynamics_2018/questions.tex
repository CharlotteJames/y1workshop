...
\item Using this inequality along with what you know about conservative forces, determine the minimum value of $v_1$, as a function of $g$ and $R$, which ensures the mass will not leave the track as it passes through the loop. 
\end{enumerate}
}