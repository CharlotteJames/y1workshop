...
Consider a rod of known length $l$ and mass $m$ resting on three supports, as shown below.
            ...
            \end{center}
            \begin{enumerate}
            \item Draw a free-body diagram for the rod. Suppose we know that $N_{3}=4$. Use the external force balance and moment balance about $A$ to find the reaction forces $N_{1}$ and $N_{2}$. 
