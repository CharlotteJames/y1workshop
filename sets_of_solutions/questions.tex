    ...
    \begin{enumerate}
        ...
        \item Consider the same equation in modular arithmetic
            \[
                a\,x = b \Mod{n}
            \]
            with $a,b,x\in\mathbb{Z}$ and $n\in\mathbb{N}$. For example if we
            have
            \[
                x = 1 \Mod{2}
            \]
            then the solution is $x\in O$ where $O$ is the set of odd numbers.
            We can spell this out explicitly with $x \in \left\{2n+1 :
                n\in\mathbb{Z}\right\}$.
            \begin{enumerate}
